...
5. Flutter loads `GET /businesses/:id/app-context` for business context,
   current membership, role permissions, and public menu link data.
6. Staff can view limited business information and the public link, but cannot
   edit the menu or manage members.
7. Customer scans a QR code generated by the client and sees the public menu
   website.
